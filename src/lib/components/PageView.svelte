...
<div
	class="flex h-full flex-1 flex-col overflow-y-scroll rounded-xl bg-base-100 px-2 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-neutral/[0.15] scrollbar-thumb-rounded-md"
>
